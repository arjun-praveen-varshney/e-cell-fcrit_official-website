  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        {name: 'values', type: 'array', of: [{type: 'string'}], title: 'Core Values'},
      ],
    }),
    defineField({
      name: 'statistics',
      ...
      type: 'object',
      fields: [
        {name: 'studentsImpacted', type: 'number', title: 'Students Impacted'},
        {name: 'eventsOrganized', type: 'number', title: 'Events Organized'},
        {name: 'startupsIncubated', type: 'number', title: 'Startups Incubated'},
        {name: 'industryPartners', type: 'number', title: 'Industry Partners'},
        {name: 'communityReach', type: 'number', title: 'Community Reach'},
        {name: 'fundingFacilitated', type: 'string', title: 'Funding Facilitated'},
      ],
    }),
  ],
  preview: {
